...
namespace CoreCodeCamp.Controllers
{
    ...
    public class CampsController : ControllerBase
    {
        ...
        [HttpGet("search")]
        public async Task<ActionResult<CampModel[]>> SearchByData(DateTime date, bool includeTalks = false)
        {
            try
            {
        ...
        public async Task<ActionResult<CampModel>> Post(CampModel model)
        {
            try
            {
                var postMoniker = await _repository.GetCampAsync(model.Moniker);

                //Checks to see if the moniker alreadys exsits. 
                if (postMoniker != null)
                {
                ...
                //Returns that the camp has been created sucsesfuly. 
